          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Thomas and I'm a`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Tech Enthusiast", "Web Developer", "Nerd" ]'><span className="wrap">{text}</span></span></h1>
